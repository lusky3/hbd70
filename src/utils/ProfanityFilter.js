...
// Family-friendly profanity filter for player initials tags and optional full names
...
export function isProfaneText(text) {
  ...
  // Check against blocked words and blocked tags per token
  ...
  // Also check direct match on compressed string for bypassed spacing (e.g. "f u c k" or "fuuuuck")
