...
<!-- Framework: Phaser 3 + Fastify + SQLite | Generated: 2026-09-19 -->
...
> **Configured for HBD70**: Official doc URLs for the project's chosen technologies.

| Technology | Official Doc URL | Notes |
|---|---|---|
| Phaser 3 | https://newdocs.phaser.io/ | Scenes, GameObjects, Input, Scale, Physics, Audio |
| Vite | https://vite.dev/guide/ | Build config, plugins, dev server, asset bundling |
| Fastify | https://fastify.dev/docs/latest/ | Server setup, routes, hooks, cookies, plugins |
| SQLite | https://www.sqlite.org/docs.html | SQL syntax, SQLite features, constraints |
| Drizzle ORM | https://orm.drizzle.team/docs/overview | Schema declaration, migrations, query builders |
| Vitest | https://vitest.dev/guide/ | Unit testing, mocks, assertions |
| Playwright | https://playwright.dev/docs/intro | End-to-end testing, mobile viewport emulation |
